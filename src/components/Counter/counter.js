...
const Counter = (props) => {
  const { value, increment, doubleAsync, getComicsCollection } = props;
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.containerCounter}>
        ...
        <TouchableOpacity onPress={() => getComicsCollection()} style={styles.button}>
          <Text style={styles.buttonText}> Get Comics Collection </Text>
        </TouchableOpacity>
      </View>
    </View>
  )
